...
async function main() {
  ...
  const logoSvg = await readFile(new URL('https://d21gfi7kzrpyzn.cloudfront.net/assets/logo.svg', import.meta.url), 'utf8');
  const faviconSvg = await readFile(new URL('https://d21gfi7kzrpyzn.cloudfront.net/assets/favicon.svg', import.meta.url), 'utf8');
